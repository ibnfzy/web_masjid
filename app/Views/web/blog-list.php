  ...
  <div class="container">
    <div class="row justify-content-md-center">
      <div class="col-12 col-md-10 col-lg-8 col-xl-7 col-xxl-6">
        <h2 class="display-5 mb-4 mb-md-5 text-center"><?= $title; ?></h2>
        ...
        <article>
          <div class="card border-0 bg-transparent">
            <figure class="card-img-top mb-4 overflow-hidden bsb-overlay-hover">
              <a href="#!">
                <img class="img-fluid bsb-scale bsb-hover-scale-up" loading="lazy" src="<?= base_url('MASJID.png') ?>" alt="Living">
              </a>
              <figcaption>
            ...
            <div class="card-body m-0 p-0">
              <div class="entry-header mb-3">
                ...
                <h2 class="card-title entry-title h4 m-0">
                  <a class="link-dark text-decoration-none" href="#!">How to Use Facial Expressions in Public
                    Speaking</a>
                </h2>
              </div>
            </div>
