...
<div class="container-fluid px-4">
  <h1 class="mt-4">Kelola Postingan Lembaga</h1>
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
              ...
              <a href="/OperatorPanel/Lembaga/Delete/<?= $item['id'] ?>" class="btn btn-danger">Hapus</a>
            </td>
          </tr>
          <?php endforeach ?>
        </tbody>
...
<div class="modal fade" id="add" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <form action="/OperatorPanel/Lembaga" method="post" enctype="multipart/form-data">
...
<div class="modal fade" id="edit" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form action="/OperatorPanel/Lembaga/Update" method="post" enctype="multipart/form-data">
