...
<div class="container-fluid px-4">
  <h1 class="mt-4">Kelola Postingan Layanan</h1>
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
              ...
              <a href="/OperatorPanel/Layanan/Delete/<?= $item['id'] ?>" class="btn btn-danger">Hapus</a>
            </td>
          </tr>
          <?php endforeach ?>
        </tbody>
...
<div class="modal fade" id="add" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form enctype="multipart/form-data" action="/OperatorPanel/Layanan" method="post">
...
<div class="modal fade" id="edit" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form enctype="multipart/form-data" action="/OperatorPanel/Layanan/Update" method="post"
